...
import { DeshboardDetailsComponent } from './analytics/deshboard-details/deshboard-details.component';
...
@NgModule({
  ...
  declarations: [
    ...
    DeshboardDetailsComponent,


  ],
  entryComponents:[DeshboardDetailsComponent]
